...
async function onNewConnection(socket: UserSocket, next: any) {
    ...
    // ONLY FOR TESTING
    socket.user = {
        iss: "https://securetoken.google.com/lawsomeai",
        aud: "lawsomeai",
        auth_time: 1687332574,
        user_id: "jD7eF2XwFDPAGxe7NA44uLhOGp63",
        sub: "jD7eF2XwFDPAGxe7NA44uLhOGp63",
        iat: 1687332574,
        exp: 1687336174,
        email: "test@gmail.com",
        email_verified: false,
        firebase: { identities: { email: ["test@gmail.com"] }, sign_in_provider: "password" },
        uid: "jD7eF2XwFDPAGxe7NA44uLhOGp63",
    };
